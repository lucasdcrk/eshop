 ...
 * @endcode
 */
$settings['hash_salt'] = 'IVwasvZGOnmVhTqP0xHiMOMGCF7-EkCQYzdWpjxML7WRyBS--OQ4byp-etHPmJcDLaGOXrTPmw';
...
$databases['default']['default'] = array (
  'database' => 'eshop-prod',
  'username' => 'eshop-prod',
  'password' => 'tiFwD2WewwtsH9QVPwov',
  'prefix' => '',
  'host' => 'cloudpanel.sitaxis.net',
  'port' => '3306',
  'namespace' => 'Drupal\\mysql\\Driver\\Database\\mysql',
  'driver' => 'mysql',
  'autoload' => 'core/modules/mysql/src/Driver/Database/mysql/',
);
$settings['config_sync_directory'] = 'sites/default/files/config_A1p-wKzbdQlRCzl0vj8vcmSTyHp7F8hZs3s_25VtPNXZ3_L7LoVqseQWhEDXEaXLp3HoSwQfTQ/sync';
